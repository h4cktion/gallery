...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen w-full">
      <div className="p-4  w-full md:w-10/12 shadow-lg flex flex-col gap-4 ">
        <h2 className="my-4 text-xl font-bold">Accès à votre album privé</h2>
        <p className="mb-6">
          Saississez l&lsquo;identifiant que votre photographe vous a fourni.
        </p>
